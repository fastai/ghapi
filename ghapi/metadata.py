funcs = [('/app', 'get', 'apps/get-authenticated', 'Get the authenticated app', 'v3/apps/#get-the-authenticated-app', [], []),
 ...
 ('/app/hook/config', 'patch', 'apps/update-webhook-config-for-app', 'Update a webhook configuration for an app', 'v3/apps#update-a-webhook-configuration-for-an-app', [], ['url', 'content_type', 'secret', 'insecure_ssl']),
 ...
 ('/app/installations/{installation_id}/access_tokens', 'post', 'apps/create-installation-access-token', 'Create an installation access token for an app', 'v3/apps/#create-an-installation-access-token-for-an-app', [], ['repositories', 'repository_ids', 'permissions']),
 ...
 ('/applications/{client_id}/grant', 'delete', 'apps/delete-authorization', 'Delete an app authorization', 'rest/reference/apps#delete-an-app-authorization', [], ['access_token']),
 ...
 ('/applications/{client_id}/token', 'post', 'apps/check-token', 'Check a token', 'rest/reference/apps#check-a-token', [], ['access_token']),
 ('/applications/{client_id}/token', 'patch', 'apps/reset-token', 'Reset a token', 'rest/reference/apps#reset-a-token', [], ['access_token']),
 ('/applications/{client_id}/token', 'delete', 'apps/delete-token', 'Delete an app token', 'rest/reference/apps#delete-an-app-token', [], ['access_token']),
 ...
 ('/authorizations', 'post', 'oauth-authorizations/create-authorization', 'Create a new authorization', 'rest/reference/oauth-authorizations#create-a-new-authorization', [], ['scopes', 'note', 'note_url', 'client_id', 'client_secret', 'fingerprint']),
 ('/authorizations/clients/{client_id}', 'put', 'oauth-authorizations/get-or-create-authorization-for-app', 'Get-or-create an authorization for a specific app', 'rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app', [], ['client_secret', 'scopes', 'note', 'note_url', 'fingerprint']),
 ('/authorizations/clients/{client_id}/{fingerprint}',
  ...
  [],
  ['client_secret', 'scopes', 'note', 'note_url']),
 ...
 ('/authorizations/{authorization_id}', 'patch', 'oauth-authorizations/update-authorization', 'Update an existing authorization', 'rest/reference/oauth-authorizations#update-an-existing-authorization', [], ['scopes', 'add_scopes', 'remove_scopes', 'note', 'note_url', 'fingerprint']),
 ...
 ('/codes_of_conduct', 'get', 'codes-of-conduct/get-all-codes-of-conduct', 'Get all codes of conduct', 'v3/codes_of_conduct/#get-all-codes-of-conduct', [], []),
 ('/codes_of_conduct/{key}', 'get', 'codes-of-conduct/get-conduct-code', 'Get a code of conduct', 'v3/codes_of_conduct/#get-a-code-of-conduct', [], []),
 ('/content_references/{content_reference_id}/attachments', 'post', 'apps/create-content-attachment', 'Create a content attachment', 'rest/reference/apps#create-a-content-attachment', [], ['title', 'body']),
 ...
 ('/enterprises/{enterprise}/actions/permissions', 'put', 'enterprise-admin/set-github-actions-permissions-enterprise', 'Set GitHub Actions permissions for an enterprise', 'rest/reference/enterprise-admin#set-github-actions-permissions-for-an-enterprise', [], ['enabled_organizations', 'allowed_actions']),
 ...
 ('/enterprises/{enterprise}/actions/permissions/selected-actions', 'put', 'enterprise-admin/set-allowed-actions-enterprise', 'Set allowed actions for an enterprise', 'rest/reference/enterprise-admin#set-allowed-actions-for-an-enterprise', [], ['github_owned_allowed', 'verified_allowed', 'patterns_allowed']),
 ...
 ('/enterprises/{enterprise}/actions/runner-groups', 'post', 'enterprise-admin/create-self-hosted-runner-group-for-enterprise', 'Create a self-hosted runner group for an enterprise', 'rest/reference/enterprise-admin#create-self-hosted-runner-group-for-an-enterprise', [], ['name', 'visibility', 'selected_organization_ids', 'runners']),
 ...
 ('/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}', 'patch', 'enterprise-admin/update-self-hosted-runner-group-for-enterprise', 'Update a self-hosted runner group for an enterprise', 'rest/reference/enterprise-admin#update-a-self-hosted-runner-group-for-an-enterprise', [], ['name', 'visibility']),
 ...
 ('/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/runners', 'put', 'enterprise-admin/set-self-hosted-runners-in-group-for-enterprise', 'Set self-hosted runners in a group for an enterprise', 'rest/reference/enterprise-admin#set-self-hosted-runners-in-a-group-for-an-enterprise', [], ['runners']),
 ...
 ('/gists', 'post', 'gists/create', 'Create a gist', 'v3/gists/#create-a-gist', [], ['description', 'files', 'public']),
 ...
 ('/gists/{gist_id}', 'patch', 'gists/update', 'Update a gist', 'v3/gists/#update-a-gist', [], ['description', 'files']),
 ...
 ('/gists/{gist_id}/comments', 'post', 'gists/create-comment', 'Create a gist comment', 'rest/reference/gists#create-a-gist-comment', [], ['body']),
 ('/gists/{gist_id}/comments/{comment_id}', 'get', 'gists/get-comment', 'Get a gist comment', 'rest/reference/gists#get-a-gist-comment', [], []),
 ('/gists/{gist_id}/comments/{comment_id}', 'patch', 'gists/update-comment', 'Update a gist comment', 'rest/reference/gists#update-a-gist-comment', [], ['body']),
 ...
 ('/issues', 'get', 'issues/list', 'List issues assigned to the authenticated user', 'v3/issues/#list-issues-assigned-to-the-authenticated-user', ['filter', 'state', 'labels', 'sort', 'direction', 'since', 'collab', 'orgs', 'owned', 'pulls', 'per_page', 'page'], []),
 ...
 ('/markdown', 'post', 'markdown/render', 'Render a Markdown document', 'v3/markdown/#render-a-markdown-document', [], ['text', 'mode', 'context']),
 ...
 ('/notifications', 'put', 'activity/mark-notifications-as-read', 'Mark notifications as read', 'rest/reference/activity#mark-notifications-as-read', [], ['last_read_at', 'read']),
 ...
 ('/notifications/threads/{thread_id}/subscription', 'put', 'activity/set-thread-subscription', 'Set a thread subscription', 'rest/reference/activity#set-a-thread-subscription', [], ['ignored']),
 ...
 ('/orgs/{org}', 'get', 'orgs/get', 'Get an organization', 'v3/orgs/#get-an-organization', [], []),
 ('/orgs/{org}',
  'patch',
  'orgs/update',
 ...
 ('/orgs/{org}/actions/permissions', 'put', 'actions/set-github-actions-permissions-organization', 'Set GitHub Actions permissions for an organization', 'rest/reference/actions#set-github-actions-permissions-for-an-organization', [], ['enabled_repositories', 'allowed_actions']),
 ...
 ('/orgs/{org}/actions/permissions/selected-actions', 'put', 'actions/set-allowed-actions-organization', 'Set allowed actions for an organization', 'rest/reference/actions#set-allowed-actions-for-an-organization', [], ['github_owned_allowed', 'verified_allowed', 'patterns_allowed']),
 ...
 ('/orgs/{org}/actions/runner-groups', 'post', 'actions/create-self-hosted-runner-group-for-org', 'Create a self-hosted runner group for an organization', 'rest/reference/actions#create-a-self-hosted-runner-group-for-an-organization', [], ['name', 'visibility', 'selected_repository_ids', 'runners']),
 ...
 ('/orgs/{org}/actions/runner-groups/{runner_group_id}', 'patch', 'actions/update-self-hosted-runner-group-for-org', 'Update a self-hosted runner group for an organization', 'rest/reference/actions#update-a-self-hosted-runner-group-for-an-organization', [], ['name', 'visibility']),
 ...
 ('/orgs/{org}/actions/runner-groups/{runner_group_id}/runners', 'put', 'actions/set-self-hosted-runners-in-group-for-org', 'Set self-hosted runners in a group for an organization', 'rest/reference/actions#set-self-hosted-runners-in-a-group-for-an-organization', [], ['runners']),
 ...
 ('/orgs/{org}/actions/secrets/{secret_name}', 'put', 'actions/create-or-update-org-secret', 'Create or update an organization secret', 'rest/reference/actions#create-or-update-an-organization-secret', [], ['encrypted_value', 'key_id', 'visibility', 'selected_repository_ids']),
 ...
 ('/orgs/{org}/actions/secrets/{secret_name}/repositories', 'put', 'actions/set-selected-repos-for-org-secret', 'Set selected repositories for an organization secret', 'rest/reference/actions#set-selected-repositories-for-an-organization-secret', [], ['selected_repository_ids']),
 ...
 ('/orgs/{org}/hooks', 'post', 'orgs/create-webhook', 'Create an organization webhook', 'rest/reference/orgs#create-an-organization-webhook', [], ['name', 'config', 'events', 'active']),
 ('/orgs/{org}/hooks/{hook_id}', 'get', 'orgs/get-webhook', 'Get an organization webhook', 'rest/reference/orgs#get-an-organization-webhook', [], []),
 ('/orgs/{org}/hooks/{hook_id}', 'patch', 'orgs/update-webhook', 'Update an organization webhook', 'rest/reference/orgs#update-an-organization-webhook', [], ['config', 'events', 'active', 'name']),
 ...
 ('/orgs/{org}/hooks/{hook_id}/config', 'patch', 'orgs/update-webhook-config-for-org', 'Update a webhook configuration for an organization', 'v3/orgs#update-a-webhook-configuration-for-an-organization', [], ['url', 'content_type', 'secret', 'insecure_ssl']),
 ...
 ('/orgs/{org}/interaction-limits', 'put', 'interactions/set-restrictions-for-org', 'Set interaction restrictions for an organization', 'rest/reference/interactions#set-interaction-restrictions-for-an-organization', [], ['limit', 'expiry']),
 ...
 ('/orgs/{org}/invitations', 'post', 'orgs/create-invitation', 'Create an organization invitation', 'rest/reference/orgs#create-an-organization-invitation', [], ['invitee_id', 'email', 'role', 'team_ids']),
 ...
 ('/orgs/{org}/issues', 'get', 'issues/list-for-org', 'List organization issues assigned to the authenticated user', 'v3/issues/#list-organization-issues-assigned-to-the-authenticated-user', ['filter', 'state', 'labels', 'sort', 'direction', 'since', 'per_page', 'page'], []),
 ...
 ('/orgs/{org}/memberships/{username}', 'put', 'orgs/set-membership-for-user', 'Set organization membership for a user', 'rest/reference/orgs#set-organization-membership-for-a-user', [], ['role']),
 ...
 ('/orgs/{org}/migrations', 'get', 'migrations/list-for-org', 'List organization migrations', 'rest/reference/migrations#list-organization-migrations', ['per_page', 'page'], []),
 ('/orgs/{org}/migrations', 'post', 'migrations/start-for-org', 'Start an organization migration', 'rest/reference/migrations#start-an-organization-migration', [], ['repositories', 'lock_repositories', 'exclude_attachments', 'exclude']),
 ('/orgs/{org}/migrations/{migration_id}', 'get', 'migrations/get-status-for-org', 'Get an organization migration status', 'rest/reference/migrations#get-an-organization-migration-status', [], []),
 ('/orgs/{org}/migrations/{migration_id}/archive', 'get', 'migrations/download-archive-for-org', 'Download an organization migration archive', 'rest/reference/migrations#download-an-organization-migration-archive', [], []),
 ('/orgs/{org}/migrations/{migration_id}/archive', 'delete', 'migrations/delete-archive-for-org', 'Delete an organization migration archive', 'rest/reference/migrations#delete-an-organization-migration-archive', [], []),
 ('/orgs/{org}/migrations/{migration_id}/repos/{repo_name}/lock', 'delete', 'migrations/unlock-repo-for-org', 'Unlock an organization repository', 'rest/reference/migrations#unlock-an-organization-repository', [], []),
 ('/orgs/{org}/migrations/{migration_id}/repositories', 'get', 'migrations/list-repos-for-org', 'List repositories in an organization migration', 'rest/reference/migrations#list-repositories-in-an-organization-migration', ['per_page', 'page'], []),
 ...
 ('/orgs/{org}/projects', 'get', 'projects/list-for-org', 'List organization projects', 'v3/projects/#list-organization-projects', ['state', 'per_page', 'page'], []),
 ('/orgs/{org}/projects', 'post', 'projects/create-for-org', 'Create an organization project', 'v3/projects/#create-an-organization-project', [], ['name', 'body']),
 ...
 ('/orgs/{org}/repos', 'get', 'repos/list-for-org', 'List organization repositories', 'v3/repos/#list-organization-repositories', ['type', 'sort', 'direction', 'per_page', 'page'], []),
 ('/orgs/{org}/repos',
  'post',
  'repos/create-in-org',
 ...
 ('/orgs/{org}/teams', 'post', 'teams/create', 'Create a team', 'v3/teams/#create-a-team', [], ['name', 'description', 'maintainers', 'repo_names', 'privacy', 'permission', 'parent_team_id']),
 ('/orgs/{org}/teams/{team_slug}', 'get', 'teams/get-by-name', 'Get a team by name', 'v3/teams/#get-a-team-by-name', [], []),
 ('/orgs/{org}/teams/{team_slug}', 'patch', 'teams/update-in-org', 'Update a team', 'v3/teams/#update-a-team', [], ['name', 'description', 'privacy', 'permission', 'parent_team_id']),
 ('/orgs/{org}/teams/{team_slug}', 'delete', 'teams/delete-in-org', 'Delete a team', 'v3/teams/#delete-a-team', [], []),
 ('/orgs/{org}/teams/{team_slug}/discussions', 'get', 'teams/list-discussions-in-org', 'List discussions', 'rest/reference/teams#list-discussions', ['direction', 'per_page', 'page'], []),
 ('/orgs/{org}/teams/{team_slug}/discussions', 'post', 'teams/create-discussion-in-org', 'Create a discussion', 'rest/reference/teams#create-a-discussion', [], ['title', 'body', 'private']),
 ...
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}', 'patch', 'teams/update-discussion-in-org', 'Update a discussion', 'rest/reference/teams#update-a-discussion', [], ['title', 'body']),
 ...
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments', 'post', 'teams/create-discussion-comment-in-org', 'Create a discussion comment', 'rest/reference/teams#create-a-discussion-comment', [], ['body']),
 ...
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}', 'patch', 'teams/update-discussion-comment-in-org', 'Update a discussion comment', 'rest/reference/teams#update-a-discussion-comment', [], ['body']),
 ...
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'get', 'reactions/list-for-team-discussion-comment-in-org', 'List reactions for a team discussion comment', 'v3/reactions/#list-reactions-for-a-team-discussion-comment', ['content', 'per_page', 'page'], []),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'post', 'reactions/create-for-team-discussion-comment-in-org', 'Create reaction for a team discussion comment', 'v3/reactions/#create-reaction-for-a-team-discussion-comment', [], ['content']),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-team-discussion-comment', 'Delete team discussion comment reaction', 'v3/reactions/#delete-team-discussion-comment-reaction', [], []),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions', 'get', 'reactions/list-for-team-discussion-in-org', 'List reactions for a team discussion', 'v3/reactions/#list-reactions-for-a-team-discussion', ['content', 'per_page', 'page'], []),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions', 'post', 'reactions/create-for-team-discussion-in-org', 'Create reaction for a team discussion', 'v3/reactions/#create-reaction-for-a-team-discussion', [], ['content']),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-team-discussion', 'Delete team discussion reaction', 'v3/reactions/#delete-team-discussion-reaction', [], []),
 ...
 ('/orgs/{org}/teams/{team_slug}/memberships/{username}', 'put', 'teams/add-or-update-membership-for-user-in-org', 'Add or update team membership for a user', 'rest/reference/teams#add-or-update-team-membership-for-a-user', [], ['role']),
 ...
 ('/orgs/{org}/teams/{team_slug}/projects', 'get', 'teams/list-projects-in-org', 'List team projects', 'v3/teams/#list-team-projects', ['per_page', 'page'], []),
 ('/orgs/{org}/teams/{team_slug}/projects/{project_id}', 'get', 'teams/check-permissions-for-project-in-org', 'Check team permissions for a project', 'v3/teams/#check-team-permissions-for-a-project', [], []),
 ('/orgs/{org}/teams/{team_slug}/projects/{project_id}', 'put', 'teams/add-or-update-project-permissions-in-org', 'Add or update team project permissions', 'v3/teams/#add-or-update-team-project-permissions', [], ['permission']),
 ...
 ('/orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}', 'put', 'teams/add-or-update-repo-permissions-in-org', 'Add or update team repository permissions', 'v3/teams/#add-or-update-team-repository-permissions', [], ['permission']),
 ...
 ('/orgs/{org}/teams/{team_slug}/team-sync/group-mappings', 'patch', 'teams/create-or-update-idp-group-connections-in-org', 'Create or update IdP group connections', 'rest/reference/teams#create-or-update-idp-group-connections', [], ['groups']),
 ...
 ('/projects/columns/cards/{card_id}', 'patch', 'projects/update-card', 'Update an existing project card', 'rest/reference/projects#update-a-project-card', [], ['note', 'archived']),
 ...
 ('/projects/columns/cards/{card_id}/moves', 'post', 'projects/move-card', 'Move a project card', 'rest/reference/projects#move-a-project-card', [], ['position', 'column_id']),
 ('/projects/columns/{column_id}', 'get', 'projects/get-column', 'Get a project column', 'rest/reference/projects#get-a-project-column', [], []),
 ('/projects/columns/{column_id}', 'patch', 'projects/update-column', 'Update an existing project column', 'rest/reference/projects#update-a-project-column', [], ['name']),
 ...
 ('/projects/columns/{column_id}/cards', 'post', 'projects/create-card', 'Create a project card', 'rest/reference/projects#create-a-project-card', [], []),
 ('/projects/columns/{column_id}/moves', 'post', 'projects/move-column', 'Move a project column', 'rest/reference/projects#move-a-project-column', [], ['position']),
 ('/projects/{project_id}', 'get', 'projects/get', 'Get a project', 'v3/projects/#get-a-project', [], []),
 ('/projects/{project_id}', 'patch', 'projects/update', 'Update a project', 'v3/projects/#update-a-project', [], ['name', 'body', 'state', 'organization_permission', 'private']),
 ('/projects/{project_id}', 'delete', 'projects/delete', 'Delete a project', 'v3/projects/#delete-a-project', [], []),
 ...
 ('/projects/{project_id}/collaborators/{username}', 'put', 'projects/add-collaborator', 'Add project collaborator', 'rest/reference/projects#add-project-collaborator', [], ['permission']),
 ...
 ('/projects/{project_id}/columns', 'post', 'projects/create-column', 'Create a project column', 'rest/reference/projects#create-a-project-column', [], ['name']),
 ...
 ('/reactions/{reaction_id}', 'delete', 'reactions/delete-legacy', 'Delete a reaction (Legacy)', 'v3/reactions/#delete-a-reaction-legacy', [], []),
 ('/repos/{owner}/{repo}', 'get', 'repos/get', 'Get a repository', 'v3/repos/#get-a-repository', [], []),
 ('/repos/{owner}/{repo}', 'patch', 'repos/update', 'Update a repository', 'v3/repos/#update-a-repository', [], ['name', 'description', 'homepage', 'private', 'visibility', 'has_issues', 'has_projects', 'has_wiki', 'is_template', 'default_branch', 'allow_squash_merge', 'allow_merge_commit', 'allow_rebase_merge', 'delete_branch_on_merge', 'archived']),
 ...
 ('/repos/{owner}/{repo}/actions/permissions', 'put', 'actions/set-github-actions-permissions-repository', 'Set GitHub Actions permissions for a repository', 'rest/reference/actions#set-github-actions-permissions-for-a-repository', [], ['enabled', 'allowed_actions']),
 ...
 ('/repos/{owner}/{repo}/actions/permissions/selected-actions', 'put', 'actions/set-allowed-actions-repository', 'Set allowed actions for a repository', 'rest/reference/actions#set-allowed-actions-for-a-repository', [], ['github_owned_allowed', 'verified_allowed', 'patterns_allowed']),
 ...
 ('/repos/{owner}/{repo}/actions/secrets/{secret_name}', 'put', 'actions/create-or-update-repo-secret', 'Create or update a repository secret', 'rest/reference/actions#create-or-update-a-repository-secret', [], ['encrypted_value', 'key_id']),
 ...
 ('/repos/{owner}/{repo}/actions/workflows/{workflow_id}/dispatches', 'post', 'actions/create-workflow-dispatch', 'Create a workflow dispatch event', 'rest/reference/actions#create-a-workflow-dispatch-event', [], ['ref', 'inputs']),
 ...
 ('/repos/{owner}/{repo}/automated-security-fixes', 'put', 'repos/enable-automated-security-fixes', 'Enable automated security fixes', 'v3/repos/#enable-automated-security-fixes', [], []),
 ('/repos/{owner}/{repo}/automated-security-fixes', 'delete', 'repos/disable-automated-security-fixes', 'Disable automated security fixes', 'v3/repos/#disable-automated-security-fixes', [], []),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection', 'get', 'repos/get-branch-protection', 'Get branch protection', 'rest/reference/repos#get-branch-protection', [], []),
 ('/repos/{owner}/{repo}/branches/{branch}/protection', 'put', 'repos/update-branch-protection', 'Update branch protection', 'rest/reference/repos#update-branch-protection', [], ['required_status_checks', 'enforce_admins', 'required_pull_request_reviews', 'restrictions', 'required_linear_history', 'allow_force_pushes', 'allow_deletions']),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_pull_request_reviews', 'get', 'repos/get-pull-request-review-protection', 'Get pull request review protection', 'rest/reference/repos#get-pull-request-review-protection', [], []),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures', 'get', 'repos/get-commit-signature-protection', 'Get commit signature protection', 'rest/reference/repos#get-commit-signature-protection', [], []),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures', 'post', 'repos/create-commit-signature-protection', 'Create commit signature protection', 'rest/reference/repos#create-commit-signature-protection', [], []),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures', 'delete', 'repos/delete-commit-signature-protection', 'Delete commit signature protection', 'rest/reference/repos#delete-commit-signature-protection', [], []),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks', 'patch', 'repos/update-status-check-protection', 'Update status check protection', 'rest/reference/repos#update-status-check-potection', [], ['strict', 'contexts']),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', 'post', 'repos/add-status-check-contexts', 'Add status check contexts', 'rest/reference/repos#add-status-check-contexts', [], ['contexts']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', 'put', 'repos/set-status-check-contexts', 'Set status check contexts', 'rest/reference/repos#set-status-check-contexts', [], ['contexts']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', 'delete', 'repos/remove-status-check-contexts', 'Remove status check contexts', 'rest/reference/repos#remove-status-check-contexts', [], ['contexts']),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', 'post', 'repos/add-app-access-restrictions', 'Add app access restrictions', 'rest/reference/repos#add-app-access-restrictions', [], ['apps']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', 'put', 'repos/set-app-access-restrictions', 'Set app access restrictions', 'rest/reference/repos#set-app-access-restrictions', [], ['apps']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', 'delete', 'repos/remove-app-access-restrictions', 'Remove app access restrictions', 'rest/reference/repos#remove-app-access-restrictions', [], ['apps']),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', 'post', 'repos/add-team-access-restrictions', 'Add team access restrictions', 'rest/reference/repos#add-team-access-restrictions', [], ['teams']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', 'put', 'repos/set-team-access-restrictions', 'Set team access restrictions', 'rest/reference/repos#set-team-access-restrictions', [], ['teams']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', 'delete', 'repos/remove-team-access-restrictions', 'Remove team access restrictions', 'rest/reference/repos#remove-team-access-restrictions', [], ['teams']),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', 'post', 'repos/add-user-access-restrictions', 'Add user access restrictions', 'rest/reference/repos#add-user-access-restrictions', [], ['users']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', 'put', 'repos/set-user-access-restrictions', 'Set user access restrictions', 'rest/reference/repos#set-user-access-restrictions', [], ['users']),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', 'delete', 'repos/remove-user-access-restrictions', 'Remove user access restrictions', 'rest/reference/repos#remove-user-access-restrictions', [], ['users']),
 ('/repos/{owner}/{repo}/check-runs', 'post', 'checks/create', 'Create a check run', 'rest/reference/checks#create-a-check-run', [], ['name', 'head_sha', 'details_url', 'external_id', 'status', 'started_at', 'conclusion', 'completed_at', 'output', 'actions']),
 ('/repos/{owner}/{repo}/check-runs/{check_run_id}', 'get', 'checks/get', 'Get a check run', 'rest/reference/checks#get-a-check-run', [], []),
 ('/repos/{owner}/{repo}/check-runs/{check_run_id}', 'patch', 'checks/update', 'Update a check run', 'rest/reference/checks#update-a-check-run', [], ['name', 'details_url', 'external_id', 'started_at', 'status', 'conclusion', 'completed_at', 'output', 'actions']),
 ...
 ('/repos/{owner}/{repo}/check-suites', 'post', 'checks/create-suite', 'Create a check suite', 'rest/reference/checks#create-a-check-suite', [], ['head_sha']),
 ('/repos/{owner}/{repo}/check-suites/preferences', 'patch', 'checks/set-suites-preferences', 'Update repository preferences for check suites', 'rest/reference/checks#update-repository-preferences-for-check-suites', [], ['auto_trigger_checks']),
 ...
 ('/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}', 'patch', 'code-scanning/update-alert', 'Update a code scanning alert', 'v3/code-scanning/#upload-a-code-scanning-alert', [], ['state', 'dismissed_reason']),
 ...
 ('/repos/{owner}/{repo}/code-scanning/sarifs', 'post', 'code-scanning/upload-sarif', 'Upload a SARIF file', 'v3/code-scanning/#upload-a-sarif-analysis', [], ['commit_sha', 'ref', 'sarif', 'checkout_uri', 'started_at', 'tool_name']),
 ...
 ('/repos/{owner}/{repo}/collaborators/{username}', 'put', 'repos/add-collaborator', 'Add a repository collaborator', 'rest/reference/repos#add-a-repository-collaborator', [], ['permission', 'permissions']),
 ...
 ('/repos/{owner}/{repo}/comments', 'get', 'repos/list-commit-comments-for-repo', 'List commit comments for a repository', 'rest/reference/repos#list-commit-comments-for-a-repository', ['per_page', 'page'], []),
 ('/repos/{owner}/{repo}/comments/{comment_id}', 'get', 'repos/get-commit-comment', 'Get a commit comment', 'rest/reference/repos#get-a-commit-comment', [], []),
 ('/repos/{owner}/{repo}/comments/{comment_id}', 'patch', 'repos/update-commit-comment', 'Update a commit comment', 'rest/reference/repos#update-a-commit-comment', [], ['body']),
 ...
 ('/repos/{owner}/{repo}/comments/{comment_id}/reactions', 'get', 'reactions/list-for-commit-comment', 'List reactions for a commit comment', 'v3/reactions/#list-reactions-for-a-commit-comment', ['content', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/comments/{comment_id}/reactions', 'post', 'reactions/create-for-commit-comment', 'Create reaction for a commit comment', 'v3/reactions/#create-reaction-for-a-commit-comment', [], ['content']),
 ('/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-commit-comment', 'Delete a commit comment reaction', 'v3/reactions/#delete-a-commit-comment-reaction', [], []),
 ...
 ('/repos/{owner}/{repo}/commits/{commit_sha}/branches-where-head', 'get', 'repos/list-branches-for-head-commit', 'List branches for HEAD commit', 'rest/reference/repos#list-branches-for-head-commit', [], []),
 ('/repos/{owner}/{repo}/commits/{commit_sha}/comments', 'get', 'repos/list-comments-for-commit', 'List commit comments', 'rest/reference/repos#list-commit-comments', ['per_page', 'page'], []),
 ('/repos/{owner}/{repo}/commits/{commit_sha}/comments', 'post', 'repos/create-commit-comment', 'Create a commit comment', 'rest/reference/repos#create-a-commit-comment', [], ['body', 'path', 'position', 'line']),
 ('/repos/{owner}/{repo}/commits/{commit_sha}/pulls', 'get', 'repos/list-pull-requests-associated-with-commit', 'List pull requests associated with a commit', 'rest/reference/repos#list-pull-requests-associated-with-a-commit', ['per_page', 'page'], []),
 ...
 ('/repos/{owner}/{repo}/community/code_of_conduct', 'get', 'codes-of-conduct/get-for-repo', 'Get the code of conduct for a repository', 'v3/codes_of_conduct/#get-the-code-of-conduct-for-a-repository', [], []),
 ...
 ('/repos/{owner}/{repo}/contents/{path}', 'put', 'repos/create-or-update-file-contents', 'Create or update file contents', 'rest/reference/repos#create-or-update-file-contents', [], ['message', 'content', 'sha', 'branch', 'committer', 'author']),
 ('/repos/{owner}/{repo}/contents/{path}', 'delete', 'repos/delete-file', 'Delete a file', 'rest/reference/repos#delete-a-file', [], ['message', 'sha', 'branch', 'committer', 'author']),
 ...
 ('/repos/{owner}/{repo}/deployments', 'get', 'repos/list-deployments', 'List deployments', 'rest/reference/repos#list-deployments', ['sha', 'ref', 'task', 'environment', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/deployments', 'post', 'repos/create-deployment', 'Create a deployment', 'rest/reference/repos#create-a-deployment', [], ['ref', 'task', 'auto_merge', 'required_contexts', 'payload', 'environment', 'description', 'transient_environment', 'production_environment', 'created_at']),
 ('/repos/{owner}/{repo}/deployments/{deployment_id}', 'get', 'repos/get-deployment', 'Get a deployment', 'rest/reference/repos#get-a-deployment', [], []),
 ...
 ('/repos/{owner}/{repo}/deployments/{deployment_id}/statuses', 'get', 'repos/list-deployment-statuses', 'List deployment statuses', 'rest/reference/repos#list-deployment-statuses', ['per_page', 'page'], []),
 ('/repos/{owner}/{repo}/deployments/{deployment_id}/statuses', 'post', 'repos/create-deployment-status', 'Create a deployment status', 'rest/reference/repos#create-a-deployment-status', [], ['state', 'target_url', 'log_url', 'description', 'environment', 'environment_url', 'auto_inactive']),
 ('/repos/{owner}/{repo}/deployments/{deployment_id}/statuses/{status_id}', 'get', 'repos/get-deployment-status', 'Get a deployment status', 'rest/reference/repos#get-a-deployment-status', [], []),
 ('/repos/{owner}/{repo}/dispatches', 'post', 'repos/create-dispatch-event', 'Create a repository dispatch event', 'v3/repos/#create-a-repository-dispatch-event', [], ['event_type', 'client_payload']),
 ...
 ('/repos/{owner}/{repo}/forks', 'post', 'repos/create-fork', 'Create a fork', 'rest/reference/repos#create-a-fork', [], ['organization']),
 ('/repos/{owner}/{repo}/git/blobs', 'post', 'git/create-blob', 'Create a blob', 'rest/reference/git#create-a-blob', [], ['content', 'encoding']),
 ('/repos/{owner}/{repo}/git/blobs/{file_sha}', 'get', 'git/get-blob', 'Get a blob', 'rest/reference/git#get-a-blob', [], []),
 ('/repos/{owner}/{repo}/git/commits', 'post', 'git/create-commit', 'Create a commit', 'rest/reference/git#create-a-commit', [], ['message', 'tree', 'parents', 'author', 'committer', 'signature']),
 ...
 ('/repos/{owner}/{repo}/git/refs', 'post', 'git/create-ref', 'Create a reference', 'rest/reference/git#create-a-reference', [], ['ref', 'sha', 'key']),
 ('/repos/{owner}/{repo}/git/refs/{ref}', 'patch', 'git/update-ref', 'Update a reference', 'rest/reference/git#update-a-reference', [], ['sha', 'force']),
 ('/repos/{owner}/{repo}/git/refs/{ref}', 'delete', 'git/delete-ref', 'Delete a reference', 'rest/reference/git#delete-a-reference', [], []),
 ('/repos/{owner}/{repo}/git/tags', 'post', 'git/create-tag', 'Create a tag object', 'rest/reference/git#create-a-tag-object', [], ['tag', 'message', 'object', 'type', 'tagger']),
 ('/repos/{owner}/{repo}/git/tags/{tag_sha}', 'get', 'git/get-tag', 'Get a tag', 'rest/reference/git#get-a-tag', [], []),
 ('/repos/{owner}/{repo}/git/trees', 'post', 'git/create-tree', 'Create a tree', 'rest/reference/git#create-a-tree', [], ['tree', 'base_tree']),
 ...
 ('/repos/{owner}/{repo}/hooks', 'post', 'repos/create-webhook', 'Create a repository webhook', 'rest/reference/repos#create-a-repository-webhook', [], ['name', 'config', 'events', 'active']),
 ...
 ('/repos/{owner}/{repo}/hooks/{hook_id}', 'patch', 'repos/update-webhook', 'Update a repository webhook', 'rest/reference/repos#update-a-repository-webhook', [], ['config', 'events', 'add_events', 'remove_events', 'active']),
 ...
 ('/repos/{owner}/{repo}/hooks/{hook_id}/config', 'patch', 'repos/update-webhook-config-for-repo', 'Update a webhook configuration for a repository', 'v3/repos#update-a-webhook-configuration-for-a-repository', [], ['url', 'content_type', 'secret', 'insecure_ssl']),
 ...
 ('/repos/{owner}/{repo}/import', 'put', 'migrations/start-import', 'Start an import', 'rest/reference/migrations#start-an-import', [], ['vcs_url', 'vcs', 'vcs_username', 'vcs_password', 'tfvc_project']),
 ('/repos/{owner}/{repo}/import', 'patch', 'migrations/update-import', 'Update an import', 'rest/reference/migrations#update-an-import', [], ['vcs_username', 'vcs_password', 'vcs', 'tfvc_project']),
 ...
 ('/repos/{owner}/{repo}/import/authors/{author_id}', 'patch', 'migrations/map-commit-author', 'Map a commit author', 'rest/reference/migrations#map-a-commit-author', [], ['email', 'name', 'remote_id']),
 ...
 ('/repos/{owner}/{repo}/import/lfs', 'patch', 'migrations/set-lfs-preference', 'Update Git LFS preference', 'rest/reference/migrations#update-git-lfs-preference', [], ['use_lfs']),
 ...
 ('/repos/{owner}/{repo}/interaction-limits', 'put', 'interactions/set-restrictions-for-repo', 'Set interaction restrictions for a repository', 'rest/reference/interactions#set-interaction-restrictions-for-a-repository', [], ['limit', 'expiry']),
 ...
 ('/repos/{owner}/{repo}/invitations/{invitation_id}', 'patch', 'repos/update-invitation', 'Update a repository invitation', 'rest/reference/repos#update-a-repository-invitation', [], ['permissions']),
 ...
 ('/repos/{owner}/{repo}/issues', 'get', 'issues/list-for-repo', 'List repository issues', 'v3/issues/#list-repository-issues', ['milestone', 'state', 'assignee', 'creator', 'mentioned', 'labels', 'sort', 'direction', 'since', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/issues', 'post', 'issues/create', 'Create an issue', 'v3/issues/#create-an-issue', [], ['title', 'body', 'assignee', 'milestone', 'labels', 'assignees']),
 ...
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}', 'patch', 'issues/update-comment', 'Update an issue comment', 'rest/reference/issues#update-an-issue-comment', [], ['body']),
 ...
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions', 'get', 'reactions/list-for-issue-comment', 'List reactions for an issue comment', 'v3/reactions/#list-reactions-for-an-issue-comment', ['content', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions', 'post', 'reactions/create-for-issue-comment', 'Create reaction for an issue comment', 'v3/reactions/#create-reaction-for-an-issue-comment', [], ['content']),
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-issue-comment', 'Delete an issue comment reaction', 'v3/reactions/#delete-an-issue-comment-reaction', [], []),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}', 'get', 'issues/get', 'Get an issue', 'v3/issues/#get-an-issue', [], []),
 ('/repos/{owner}/{repo}/issues/{issue_number}', 'patch', 'issues/update', 'Update an issue', 'v3/issues/#update-an-issue', [], ['title', 'body', 'assignee', 'state', 'milestone', 'labels', 'assignees']),
 ('/repos/{owner}/{repo}/issues/{issue_number}/assignees', 'post', 'issues/add-assignees', 'Add assignees to an issue', 'rest/reference/issues#add-assignees-to-an-issue', [], ['assignees']),
 ('/repos/{owner}/{repo}/issues/{issue_number}/assignees', 'delete', 'issues/remove-assignees', 'Remove assignees from an issue', 'rest/reference/issues#remove-assignees-from-an-issue', [], ['assignees']),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}/comments', 'post', 'issues/create-comment', 'Create an issue comment', 'rest/reference/issues#create-an-issue-comment', [], ['body']),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}/labels', 'post', 'issues/add-labels', 'Add labels to an issue', 'rest/reference/issues#add-labels-to-an-issue', [], ['labels']),
 ('/repos/{owner}/{repo}/issues/{issue_number}/labels', 'put', 'issues/set-labels', 'Set labels for an issue', 'rest/reference/issues#set-labels-for-an-issue', [], ['labels']),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}/lock', 'put', 'issues/lock', 'Lock an issue', 'v3/issues/#lock-an-issue', [], ['lock_reason']),
 ('/repos/{owner}/{repo}/issues/{issue_number}/lock', 'delete', 'issues/unlock', 'Unlock an issue', 'v3/issues/#unlock-an-issue', [], []),
 ('/repos/{owner}/{repo}/issues/{issue_number}/reactions', 'get', 'reactions/list-for-issue', 'List reactions for an issue', 'v3/reactions/#list-reactions-for-an-issue', ['content', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/issues/{issue_number}/reactions', 'post', 'reactions/create-for-issue', 'Create reaction for an issue', 'v3/reactions/#create-reaction-for-an-issue', [], ['content']),
 ('/repos/{owner}/{repo}/issues/{issue_number}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-issue', 'Delete an issue reaction', 'v3/reactions/#delete-an-issue-reaction', [], []),
 ...
 ('/repos/{owner}/{repo}/keys', 'post', 'repos/create-deploy-key', 'Create a deploy key', 'rest/reference/repos#create-a-deploy-key', [], ['title', 'key', 'read_only']),
 ...
 ('/repos/{owner}/{repo}/labels', 'post', 'issues/create-label', 'Create a label', 'rest/reference/issues#create-a-label', [], ['name', 'color', 'description']),
 ('/repos/{owner}/{repo}/labels/{name}', 'get', 'issues/get-label', 'Get a label', 'rest/reference/issues#get-a-label', [], []),
 ('/repos/{owner}/{repo}/labels/{name}', 'patch', 'issues/update-label', 'Update a label', 'rest/reference/issues#update-a-label', [], ['new_name', 'color', 'description']),
 ...
 ('/repos/{owner}/{repo}/merges', 'post', 'repos/merge', 'Merge a branch', 'rest/reference/repos#merge-a-branch', [], ['base', 'head', 'commit_message']),
 ...
 ('/repos/{owner}/{repo}/milestones', 'post', 'issues/create-milestone', 'Create a milestone', 'rest/reference/issues#create-a-milestone', [], ['title', 'state', 'description', 'due_on']),
 ...
 ('/repos/{owner}/{repo}/milestones/{milestone_number}', 'patch', 'issues/update-milestone', 'Update a milestone', 'rest/reference/issues#update-a-milestone', [], ['title', 'state', 'description', 'due_on']),
 ...
 ('/repos/{owner}/{repo}/notifications', 'put', 'activity/mark-repo-notifications-as-read', 'Mark repository notifications as read', 'rest/reference/activity#mark-repository-notifications-as-read', [], ['last_read_at']),
 ('/repos/{owner}/{repo}/pages', 'get', 'repos/get-pages', 'Get a GitHub Pages site', 'rest/reference/repos#get-a-github-pages-site', [], []),
 ('/repos/{owner}/{repo}/pages', 'post', 'repos/create-pages-site', 'Create a GitHub Pages site', 'rest/reference/repos#create-a-github-pages-site', [], ['source']),
 ('/repos/{owner}/{repo}/pages', 'put', 'repos/update-information-about-pages-site', 'Update information about a GitHub Pages site', 'rest/reference/repos#update-information-about-a-github-pages-site', [], ['cname', 'source']),
 ('/repos/{owner}/{repo}/pages', 'delete', 'repos/delete-pages-site', 'Delete a GitHub Pages site', 'rest/reference/repos#delete-a-github-pages-site', [], []),
 ...
 ('/repos/{owner}/{repo}/projects', 'get', 'projects/list-for-repo', 'List repository projects', 'v3/projects/#list-repository-projects', ['state', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/projects', 'post', 'projects/create-for-repo', 'Create a repository project', 'v3/projects/#create-a-repository-project', [], ['name', 'body']),
 ...
 ('/repos/{owner}/{repo}/pulls', 'post', 'pulls/create', 'Create a pull request', 'v3/pulls/#create-a-pull-request', [], ['title', 'head', 'base', 'body', 'maintainer_can_modify', 'draft', 'issue']),
 ...
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}', 'patch', 'pulls/update-review-comment', 'Update a review comment for a pull request', 'rest/reference/pulls#update-a-review-comment-for-a-pull-request', [], ['body']),
 ...
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions', 'get', 'reactions/list-for-pull-request-review-comment', 'List reactions for a pull request review comment', 'v3/reactions/#list-reactions-for-a-pull-request-review-comment', ['content', 'per_page', 'page'], []),
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions', 'post', 'reactions/create-for-pull-request-review-comment', 'Create reaction for a pull request review comment', 'v3/reactions/#create-reaction-for-a-pull-request-review-comment', [], ['content']),
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-pull-request-comment', 'Delete a pull request comment reaction', 'v3/reactions/#delete-a-pull-request-comment-reaction', [], []),
 ('/repos/{owner}/{repo}/pulls/{pull_number}', 'get', 'pulls/get', 'Get a pull request', 'v3/pulls/#get-a-pull-request', [], []),
 ('/repos/{owner}/{repo}/pulls/{pull_number}', 'patch', 'pulls/update', 'Update a pull request', 'v3/pulls/#update-a-pull-request', [], ['title', 'body', 'state', 'base', 'maintainer_can_modify']),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/comments', 'post', 'pulls/create-review-comment', 'Create a review comment for a pull request', 'rest/reference/pulls#create-a-review-comment-for-a-pull-request', [], ['body', 'commit_id', 'path', 'position', 'side', 'line', 'start_line', 'start_side', 'in_reply_to']),
 ('/repos/{owner}/{repo}/pulls/{pull_number}/comments/{comment_id}/replies', 'post', 'pulls/create-reply-for-review-comment', 'Create a reply for a review comment', 'rest/reference/pulls#create-a-reply-for-a-review-comment', [], ['body']),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/merge', 'put', 'pulls/merge', 'Merge a pull request', 'v3/pulls/#merge-a-pull-request', [], ['commit_title', 'commit_message', 'sha', 'merge_method']),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers', 'post', 'pulls/request-reviewers', 'Request reviewers for a pull request', 'rest/reference/pulls#request-reviewers-for-a-pull-request', [], ['reviewers', 'team_reviewers']),
 ('/repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers', 'delete', 'pulls/remove-requested-reviewers', 'Remove requested reviewers from a pull request', 'rest/reference/pulls#remove-requested-reviewers-from-a-pull-request', [], ['reviewers', 'team_reviewers']),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/reviews', 'post', 'pulls/create-review', 'Create a review for a pull request', 'rest/reference/pulls#create-a-review-for-a-pull-request', [], ['commit_id', 'body', 'event', 'comments']),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}', 'put', 'pulls/update-review', 'Update a review for a pull request', 'rest/reference/pulls#update-a-review-for-a-pull-request', [], ['body']),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/dismissals', 'put', 'pulls/dismiss-review', 'Dismiss a review for a pull request', 'rest/reference/pulls#dismiss-a-review-for-a-pull-request', [], ['message', 'event']),
 ('/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/events', 'post', 'pulls/submit-review', 'Submit a review for a pull request', 'rest/reference/pulls#submit-a-review-for-a-pull-request', [], ['body', 'event']),
 ('/repos/{owner}/{repo}/pulls/{pull_number}/update-branch', 'put', 'pulls/update-branch', 'Update a pull request branch', 'v3/pulls/#update-a-pull-request-branch', [], ['expected_head_sha']),
 ...
 ('/repos/{owner}/{repo}/releases', 'post', 'repos/create-release', 'Create a release', 'rest/reference/repos#create-a-release', [], ['tag_name', 'target_commitish', 'name', 'body', 'draft', 'prerelease']),
 ...
 ('/repos/{owner}/{repo}/releases/assets/{asset_id}', 'patch', 'repos/update-release-asset', 'Update a release asset', 'rest/reference/repos#update-a-release-asset', [], ['name', 'label', 'state']),
 ...
 ('/repos/{owner}/{repo}/releases/{release_id}', 'patch', 'repos/update-release', 'Update a release', 'rest/reference/repos#update-a-release', [], ['tag_name', 'target_commitish', 'name', 'body', 'draft', 'prerelease']),
 ...
 ('/repos/{owner}/{repo}/statuses/{sha}', 'post', 'repos/create-commit-status', 'Create a commit status', 'rest/reference/repos#create-a-commit-status', [], ['state', 'target_url', 'description', 'context']),
 ...
 ('/repos/{owner}/{repo}/subscription', 'put', 'activity/set-repo-subscription', 'Set a repository subscription', 'rest/reference/activity#set-a-repository-subscription', [], ['subscribed', 'ignored']),
 ...
 ('/repos/{owner}/{repo}/topics', 'get', 'repos/get-all-topics', 'Get all repository topics', 'v3/repos/#get-all-repository-topics', [], []),
 ('/repos/{owner}/{repo}/topics', 'put', 'repos/replace-all-topics', 'Replace all repository topics', 'v3/repos/#replace-all-repository-topics', [], ['names']),
 ...
 ('/repos/{owner}/{repo}/transfer', 'post', 'repos/transfer', 'Transfer a repository', 'v3/repos/#transfer-a-repository', [], ['new_owner', 'team_ids']),
 ('/repos/{owner}/{repo}/vulnerability-alerts', 'get', 'repos/check-vulnerability-alerts', 'Check if vulnerability alerts are enabled for a repository', 'v3/repos/#check-if-vulnerability-alerts-are-enabled-for-a-repository', [], []),
 ('/repos/{owner}/{repo}/vulnerability-alerts', 'put', 'repos/enable-vulnerability-alerts', 'Enable vulnerability alerts', 'v3/repos/#enable-vulnerability-alerts', [], []),
 ('/repos/{owner}/{repo}/vulnerability-alerts', 'delete', 'repos/disable-vulnerability-alerts', 'Disable vulnerability alerts', 'v3/repos/#disable-vulnerability-alerts', [], []),
 ...
 ('/repos/{template_owner}/{template_repo}/generate', 'post', 'repos/create-using-template', 'Create a repository using a template', 'v3/repos/#create-a-repository-using-a-template', [], ['owner', 'name', 'description', 'include_all_branches', 'private']),
 ...
 ('/scim/v2/enterprises/{enterprise}/Groups', 'post', 'enterprise-admin/provision-and-invite-enterprise-group', 'Provision a SCIM enterprise group and invite users', 'rest/reference/enterprise-admin#provision-a-scim-enterprise-group-and-invite-users', [], ['schemas', 'displayName', 'members']),
 ...
 ('/scim/v2/enterprises/{enterprise}/Groups/{scim_group_id}', 'put', 'enterprise-admin/set-information-for-provisioned-enterprise-group', 'Set SCIM information for a provisioned enterprise group', 'rest/reference/enterprise-admin#set-scim-information-for-a-provisioned-enterprise-group', [], ['schemas', 'displayName', 'members']),
 ('/scim/v2/enterprises/{enterprise}/Groups/{scim_group_id}', 'patch', 'enterprise-admin/update-attribute-for-enterprise-group', 'Update an attribute for a SCIM enterprise group', 'rest/reference/enterprise-admin#update-an-attribute-for-a-scim-enterprise-group', [], ['schemas', 'Operations']),
 ...
 ('/scim/v2/enterprises/{enterprise}/Users', 'post', 'enterprise-admin/provision-and-invite-enterprise-user', 'Provision and invite a SCIM enterprise user', 'rest/reference/enterprise-admin#provision-and-invite-a-scim-enterprise-user', [], ['schemas', 'userName', 'name', 'emails', 'groups']),
 ...
 ('/scim/v2/enterprises/{enterprise}/Users/{scim_user_id}', 'put', 'enterprise-admin/set-information-for-provisioned-enterprise-user', 'Set SCIM information for a provisioned enterprise user', 'rest/reference/enterprise-admin#set-scim-information-for-a-provisioned-enterprise-user', [], ['schemas', 'userName', 'name', 'emails', 'groups']),
 ('/scim/v2/enterprises/{enterprise}/Users/{scim_user_id}', 'patch', 'enterprise-admin/update-attribute-for-enterprise-user', 'Update an attribute for a SCIM enterprise user', 'rest/reference/enterprise-admin#update-an-attribute-for-a-scim-enterprise-user', [], ['schemas', 'Operations']),
 ...
 ('/scim/v2/organizations/{org}/Users', 'post', 'scim/provision-and-invite-user', 'Provision and invite a SCIM user', 'v3/scim/#provision-and-invite-a-scim-user', [], ['userName', 'displayName', 'name', 'emails', 'schemas', 'externalId', 'groups', 'active']),
 ...
 ('/scim/v2/organizations/{org}/Users/{scim_user_id}', 'put', 'scim/set-information-for-provisioned-user', 'Update a provisioned organization membership', 'v3/scim/#set-scim-information-for-a-provisioned-user', [], ['schemas', 'displayName', 'externalId', 'groups', 'active', 'userName', 'name', 'emails']),
 ('/scim/v2/organizations/{org}/Users/{scim_user_id}', 'patch', 'scim/update-attribute-for-user', 'Update an attribute for a SCIM user', 'v3/scim/#update-an-attribute-for-a-scim-user', [], ['schemas', 'Operations']),
 ...
 ('/search/commits', 'get', 'search/commits', 'Search commits', 'v3/search/#search-commits', ['q', 'sort', 'order', 'per_page', 'page'], []),
 ...
 ('/search/repositories', 'get', 'search/repos', 'Search repositories', 'v3/search/#search-repositories', ['q', 'sort', 'order', 'per_page', 'page'], []),
 ('/search/topics', 'get', 'search/topics', 'Search topics', 'v3/search/#search-topics', ['q'], []),
 ...
 ('/teams/{team_id}', 'patch', 'teams/update-legacy', 'Update a team (Legacy)', 'v3/teams/#update-a-team-legacy', [], ['name', 'description', 'privacy', 'permission', 'parent_team_id']),
 ...
 ('/teams/{team_id}/discussions', 'post', 'teams/create-discussion-legacy', 'Create a discussion (Legacy)', 'rest/reference/teams#create-a-discussion-legacy', [], ['title', 'body', 'private']),
 ...
 ('/teams/{team_id}/discussions/{discussion_number}', 'patch', 'teams/update-discussion-legacy', 'Update a discussion (Legacy)', 'rest/reference/teams#update-a-discussion-legacy', [], ['title', 'body']),
 ...
 ('/teams/{team_id}/discussions/{discussion_number}/comments', 'post', 'teams/create-discussion-comment-legacy', 'Create a discussion comment (Legacy)', 'rest/reference/teams#create-a-discussion-comment-legacy', [], ['body']),
 ...
 ('/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}', 'patch', 'teams/update-discussion-comment-legacy', 'Update a discussion comment (Legacy)', 'rest/reference/teams#update-a-discussion-comment-legacy', [], ['body']),
 ...
 ('/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'get', 'reactions/list-for-team-discussion-comment-legacy', 'List reactions for a team discussion comment (Legacy)', 'v3/reactions/#list-reactions-for-a-team-discussion-comment-legacy', ['content', 'per_page', 'page'], []),
 ('/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'post', 'reactions/create-for-team-discussion-comment-legacy', 'Create reaction for a team discussion comment (Legacy)', 'v3/reactions/#create-reaction-for-a-team-discussion-comment-legacy', [], ['content']),
 ('/teams/{team_id}/discussions/{discussion_number}/reactions', 'get', 'reactions/list-for-team-discussion-legacy', 'List reactions for a team discussion (Legacy)', 'v3/reactions/#list-reactions-for-a-team-discussion-legacy', ['content', 'per_page', 'page'], []),
 ('/teams/{team_id}/discussions/{discussion_number}/reactions', 'post', 'reactions/create-for-team-discussion-legacy', 'Create reaction for a team discussion (Legacy)', 'v3/reactions/#create-reaction-for-a-team-discussion-legacy', [], ['content']),
 ...
 ('/teams/{team_id}/memberships/{username}', 'put', 'teams/add-or-update-membership-for-user-legacy', 'Add or update team membership for a user (Legacy)', 'rest/reference/teams#add-or-update-team-membership-for-a-user-legacy', [], ['role']),
 ...
 ('/teams/{team_id}/projects', 'get', 'teams/list-projects-legacy', 'List team projects (Legacy)', 'v3/teams/#list-team-projects-legacy', ['per_page', 'page'], []),
 ('/teams/{team_id}/projects/{project_id}', 'get', 'teams/check-permissions-for-project-legacy', 'Check team permissions for a project (Legacy)', 'v3/teams/#check-team-permissions-for-a-project-legacy', [], []),
 ('/teams/{team_id}/projects/{project_id}', 'put', 'teams/add-or-update-project-permissions-legacy', 'Add or update team project permissions (Legacy)', 'v3/teams/#add-or-update-team-project-permissions-legacy', [], ['permission']),
 ...
 ('/teams/{team_id}/repos/{owner}/{repo}', 'put', 'teams/add-or-update-repo-permissions-legacy', 'Add or update team repository permissions (Legacy)', 'v3/teams/#add-or-update-team-repository-permissions-legacy', [], ['permission']),
 ...
 ('/teams/{team_id}/team-sync/group-mappings', 'patch', 'teams/create-or-update-idp-group-connections-legacy', 'Create or update IdP group connections (Legacy)', 'rest/reference/teams#create-or-update-idp-group-connections-legacy', [], ['groups', 'synced_at']),
 ...
 ('/user', 'patch', 'users/update-authenticated', 'Update the authenticated user', 'v3/users/#update-the-authenticated-user', [], ['name', 'email', 'blog', 'twitter_username', 'company', 'location', 'hireable', 'bio']),
 ...
 ('/user/email/visibility', 'patch', 'users/set-primary-email-visibility-for-authenticated', 'Set primary email visibility for the authenticated user', 'rest/reference/users#set-primary-email-visibility-for-the-authenticated-user', [], ['email', 'visibility']),
 ...
 ('/user/gpg_keys', 'post', 'users/create-gpg-key-for-authenticated', 'Create a GPG key for the authenticated user', 'rest/reference/users#create-a-gpg-key-for-the-authenticated-user', [], ['armored_public_key']),
 ...
 ('/user/interaction-limits', 'put', 'interactions/set-restrictions-for-your-public-repos', 'Set interaction restrictions for your public repositories', 'rest/reference/interactions#set-interaction-restrictions-for-your-public-repositories', [], ['limit', 'expiry']),
 ...
 ('/user/issues', 'get', 'issues/list-for-authenticated-user', 'List user account issues assigned to the authenticated user', 'v3/issues/#list-user-account-issues-assigned-to-the-authenticated-user', ['filter', 'state', 'labels', 'sort', 'direction', 'since', 'per_page', 'page'], []),
 ...
 ('/user/keys', 'post', 'users/create-public-ssh-key-for-authenticated', 'Create a public SSH key for the authenticated user', 'rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user', [], ['title', 'key']),
 ...
 ('/user/memberships/orgs/{org}', 'patch', 'orgs/update-membership-for-authenticated-user', 'Update an organization membership for the authenticated user', 'rest/reference/orgs#update-an-organization-membership-for-the-authenticated-user', [], ['state']),
 ('/user/migrations', 'get', 'migrations/list-for-authenticated-user', 'List user migrations', 'rest/reference/migrations#list-user-migrations', ['per_page', 'page'], []),
 ('/user/migrations', 'post', 'migrations/start-for-authenticated-user', 'Start a user migration', 'rest/reference/migrations#start-a-user-migration', [], ['lock_repositories', 'exclude_attachments', 'exclude', 'repositories']),
 ('/user/migrations/{migration_id}', 'get', 'migrations/get-status-for-authenticated-user', 'Get a user migration status', 'rest/reference/migrations#get-a-user-migration-status', ['exclude'], []),
 ('/user/migrations/{migration_id}/archive', 'get', 'migrations/get-archive-for-authenticated-user', 'Download a user migration archive', 'rest/reference/migrations#download-a-user-migration-archive', [], []),
 ('/user/migrations/{migration_id}/archive', 'delete', 'migrations/delete-archive-for-authenticated-user', 'Delete a user migration archive', 'rest/reference/migrations#delete-a-user-migration-archive', [], []),
 ('/user/migrations/{migration_id}/repos/{repo_name}/lock', 'delete', 'migrations/unlock-repo-for-authenticated-user', 'Unlock a user repository', 'rest/reference/migrations#unlock-a-user-repository', [], []),
 ('/user/migrations/{migration_id}/repositories', 'get', 'migrations/list-repos-for-user', 'List repositories for a user migration', 'rest/reference/migrations#list-repositories-for-a-user-migration', ['per_page', 'page'], []),
 ...
 ('/user/projects', 'post', 'projects/create-for-authenticated-user', 'Create a user project', 'v3/projects/#create-a-user-project', [], ['name', 'body']),
 ...
 ('/user/repos',
  ...
  [],
  ['name', 'description', 'homepage', 'private', 'has_issues', 'has_projects', 'has_wiki', 'team_id', 'auto_init', 'gitignore_template', 'license_template', 'allow_squash_merge', 'allow_merge_commit', 'allow_rebase_merge', 'delete_branch_on_merge', 'has_downloads', 'is_template']),
 ...
 ('/users/{username}/projects', 'get', 'projects/list-for-user', 'List user projects', 'v3/projects/#list-user-projects', ['state', 'per_page', 'page'], []),
 ...
 ('/users/{username}/repos', 'get', 'repos/list-for-user', 'List repositories for a user', 'v3/repos/#list-repositories-for-a-user', ['type', 'sort', 'direction', 'per_page', 'page'], []),
