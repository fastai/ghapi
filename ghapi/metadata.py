funcs = [('/app', 'get', 'apps/get-authenticated', 'Get the authenticated app', 'rest/reference/apps/#get-the-authenticated-app', [], [], ''),
 ...
 ('/codes_of_conduct', 'get', 'codes-of-conduct/get-all-codes-of-conduct', 'Get all codes of conduct', 'rest/reference/codes_of_conduct/#get-all-codes-of-conduct', [], [], 'scarlet-witch'),
 ('/codes_of_conduct/{key}', 'get', 'codes-of-conduct/get-conduct-code', 'Get a code of conduct', 'rest/reference/codes_of_conduct/#get-a-code-of-conduct', [], [], 'scarlet-witch'),
 ...
 ('/enterprises/{enterprise}/audit-log', 'get', 'audit-log/get-audit-log', 'Get the audit log for an enterprise', 'rest/reference/enterprise-admin#get-the-audit-log-for-an-enterprise', ['phrase', 'include', 'after', 'before', 'order', 'page', 'per_page'], [], ''),
 ...
 ('/issues', 'get', 'issues/list', 'List issues assigned to the authenticated user', 'rest/reference/issues/#list-issues-assigned-to-the-authenticated-user', ['filter', 'state', 'labels', 'sort', 'direction', 'since', 'collab', 'orgs', 'owned', 'pulls', 'per_page', 'page'], [], 'squirrel-girl'),
 ...
 ('/orgs/{org}', 'get', 'orgs/get', 'Get an organization', 'rest/reference/orgs/#get-an-organization', [], [], 'surtur'),
 ('/orgs/{org}',
  'patch',
  'orgs/update',
  ...
  [['billing_email', str],
   ...
   ['blog', str]],
  'surtur'),
 ('/orgs/{org}/actions/permissions', 'get', 'actions/actions-policies/get-github-actions-permissions-organization', 'Get GitHub Actions permissions for an organization', 'rest/reference/actions#get-github-actions-permissions-for-an-organization', [], [], ''),
 ...
 ('/orgs/{org}/audit-log', 'get', 'orgs/get-audit-log', 'Get the audit log for an organization', 'rest/reference/orgs#get-the-audit-log-for-an-organization', ['phrase', 'include', 'after', 'before', 'order', 'per_page', 'page'], [], ''),
 ...
 ('/orgs/{org}/credential-authorizations', 'get', 'orgs/list-saml-sso-authorizations', 'List SAML SSO authorizations for an organization', 'rest/reference/orgs/#list-saml-sso-authorizations-for-an-organization', [], [], ''),
 ...
 ('/orgs/{org}/issues', 'get', 'issues/list-for-org', 'List organization issues assigned to the authenticated user', 'rest/reference/issues/#list-organization-issues-assigned-to-the-authenticated-user', ['filter', 'state', 'labels', 'sort', 'direction', 'since', 'per_page', 'page'], [], 'squirrel-girl'),
 ...
 ('/orgs/{org}/migrations', 'get', 'migrations/list-for-org', 'List organization migrations', 'rest/reference/migrations#list-organization-migrations', ['per_page', 'page', 'exclude'], [], 'wyandotte'),
 ...
 ('/orgs/{org}/migrations/{migration_id}', 'get', 'migrations/get-status-for-org', 'Get an organization migration status', 'rest/reference/migrations#get-an-organization-migration-status', ['exclude'], [], 'wyandotte'),
 ...
 ('/orgs/{org}/packages/{package_type}/{package_name}/versions', 'get', 'packages/get-all-package-versions-for-package-owned-by-org', 'Get all package versions for a package owned by an organization', 'rest/reference/packages#get-all-package-versions-for-a-package-owned-by-the-authenticated-user', ['page', 'per_page', 'state'], [], ''),
 ...
 ('/orgs/{org}/projects', 'get', 'projects/list-for-org', 'List organization projects', 'rest/reference/projects/#list-organization-projects', ['state', 'per_page', 'page'], [], 'inertia'),
 ('/orgs/{org}/projects', 'post', 'projects/create-for-org', 'Create an organization project', 'rest/reference/projects/#create-an-organization-project', [], [['name', str], ['body', str]], 'inertia'),
 ...
 ('/orgs/{org}/repos', 'get', 'repos/list-for-org', 'List organization repositories', 'rest/reference/repos/#list-organization-repositories', ['type', 'sort', 'direction', 'per_page', 'page'], [], 'nebula'),
 ('/orgs/{org}/repos',
  'post',
  'repos/create-in-org',
 ...
 ('/orgs/{org}/teams/{team_slug}/discussions', 'get', 'teams/list-discussions-in-org', 'List discussions', 'rest/reference/teams#list-discussions', ['direction', 'per_page', 'page', 'pinned'], [], 'squirrel-girl'),
 ...
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'get', 'reactions/list-for-team-discussion-comment-in-org', 'List reactions for a team discussion comment', 'rest/reference/reactions/#list-reactions-for-a-team-discussion-comment', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'post', 'reactions/create-for-team-discussion-comment-in-org', 'Create reaction for a team discussion comment', 'rest/reference/reactions/#create-reaction-for-a-team-discussion-comment', [], [['content', str]], 'squirrel-girl'),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-team-discussion-comment', 'Delete team discussion comment reaction', 'rest/reference/reactions/#delete-team-discussion-comment-reaction', [], [], 'squirrel-girl'),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions', 'get', 'reactions/list-for-team-discussion-in-org', 'List reactions for a team discussion', 'rest/reference/reactions/#list-reactions-for-a-team-discussion', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions', 'post', 'reactions/create-for-team-discussion-in-org', 'Create reaction for a team discussion', 'rest/reference/reactions/#create-reaction-for-a-team-discussion', [], [['content', str]], 'squirrel-girl'),
 ('/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-team-discussion', 'Delete team discussion reaction', 'rest/reference/reactions/#delete-team-discussion-reaction', [], [], 'squirrel-girl'),
 ...
 ('/orgs/{org}/teams/{team_slug}/projects', 'get', 'teams/list-projects-in-org', 'List team projects', 'rest/reference/teams/#list-team-projects', ['per_page', 'page'], [], 'inertia'),
 ('/orgs/{org}/teams/{team_slug}/projects/{project_id}', 'get', 'teams/check-permissions-for-project-in-org', 'Check team permissions for a project', 'rest/reference/teams/#check-team-permissions-for-a-project', [], [], 'inertia'),
 ('/orgs/{org}/teams/{team_slug}/projects/{project_id}', 'put', 'teams/add-or-update-project-permissions-in-org', 'Add or update team project permissions', 'rest/reference/teams/#add-or-update-team-project-permissions', [], [['permission', str]], 'inertia'),
 ...
 ('/orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}', 'put', 'teams/add-or-update-repo-permissions-in-org', 'Add or update team repository permissions', 'rest/reference/teams/#add-or-update-team-repository-permissions', [], [['permission', str]], ''),
 ...
 ('/projects/{project_id}', 'get', 'projects/get', 'Get a project', 'rest/reference/projects/#get-a-project', [], [], 'inertia'),
 ('/projects/{project_id}', 'patch', 'projects/update', 'Update a project', 'rest/reference/projects/#update-a-project', [], [['name', str], ['body', str], ['state', str], ['organization_permission', str], ['private', bool]], 'inertia'),
 ('/projects/{project_id}', 'delete', 'projects/delete', 'Delete a project', 'rest/reference/projects/#delete-a-project', [], [], 'inertia'),
 ...
 ('/rate_limit', 'get', 'rate-limit/get', 'Get rate limit status for the authenticated user', 'rest/reference/rate_limit/#get-rate-limit-status-for-the-authenticated-user', [], [], ''),
 ('/reactions/{reaction_id}', 'delete', 'reactions/delete-legacy', 'Delete a reaction (Legacy)', 'rest/reference/reactions/#delete-a-reaction-legacy', [], [], 'squirrel-girl'),
 ('/repos/{owner}/{repo}', 'get', 'repos/get', 'Get a repository', 'rest/reference/repos/#get-a-repository', [], [], 'nebula'),
 ('/repos/{owner}/{repo}',
  'patch',
  'repos/update',
  'Update a repository',
 ...
 ('/repos/{owner}/{repo}/automated-security-fixes', 'put', 'repos/enable-automated-security-fixes', 'Enable automated security fixes', 'rest/reference/repos/#enable-automated-security-fixes', [], [], 'london'),
 ('/repos/{owner}/{repo}/automated-security-fixes', 'delete', 'repos/disable-automated-security-fixes', 'Disable automated security fixes', 'rest/reference/repos/#disable-automated-security-fixes', [], [], 'london'),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', 'post', 'repos/add-status-check-contexts', 'Add status check contexts', 'rest/reference/repos#add-status-check-contexts', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', 'put', 'repos/set-status-check-contexts', 'Set status check contexts', 'rest/reference/repos#set-status-check-contexts', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', 'delete', 'repos/remove-status-check-contexts', 'Remove status check contexts', 'rest/reference/repos#remove-status-check-contexts', [], [], ''),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', 'post', 'repos/add-app-access-restrictions', 'Add app access restrictions', 'rest/reference/repos#add-app-access-restrictions', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', 'put', 'repos/set-app-access-restrictions', 'Set app access restrictions', 'rest/reference/repos#set-app-access-restrictions', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', 'delete', 'repos/remove-app-access-restrictions', 'Remove app access restrictions', 'rest/reference/repos#remove-app-access-restrictions', [], [], ''),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', 'post', 'repos/add-team-access-restrictions', 'Add team access restrictions', 'rest/reference/repos#add-team-access-restrictions', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', 'put', 'repos/set-team-access-restrictions', 'Set team access restrictions', 'rest/reference/repos#set-team-access-restrictions', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', 'delete', 'repos/remove-team-access-restrictions', 'Remove team access restrictions', 'rest/reference/repos#remove-team-access-restrictions', [], [], ''),
 ...
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', 'post', 'repos/add-user-access-restrictions', 'Add user access restrictions', 'rest/reference/repos#add-user-access-restrictions', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', 'put', 'repos/set-user-access-restrictions', 'Set user access restrictions', 'rest/reference/repos#set-user-access-restrictions', [], [], ''),
 ('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', 'delete', 'repos/remove-user-access-restrictions', 'Remove user access restrictions', 'rest/reference/repos#remove-user-access-restrictions', [], [], ''),
 ...
 ('/repos/{owner}/{repo}/code-scanning/alerts', 'get', 'code-scanning/list-alerts-for-repo', 'List code scanning alerts for a repository', 'rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository', ['tool_name', 'tool_guid', 'page', 'per_page', 'ref', 'state'], [], ''),
 ...
 ('/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}/instances', 'get', 'code-scanning/list-alerts-instances', 'List instances of a code scanning alert', 'rest/reference/code-scanning#list-instances-of-a-code-scanning-alert', ['page', 'per_page', 'ref'], [], ''),
 ...
 ('/repos/{owner}/{repo}/code-scanning/sarifs', 'post', 'code-scanning/upload-sarif', 'Upload an analysis as SARIF data', 'rest/reference/code-scanning#upload-an-analysis-as-sarif-data', [], [['commit_sha', str], ['ref', str], ['sarif', str], ['checkout_uri', str], ['started_at', str], ['tool_name', str]], ''),
 ...
 ('/repos/{owner}/{repo}/comments/{comment_id}/reactions', 'get', 'reactions/list-for-commit-comment', 'List reactions for a commit comment', 'rest/reference/reactions/#list-reactions-for-a-commit-comment', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/comments/{comment_id}/reactions', 'post', 'reactions/create-for-commit-comment', 'Create reaction for a commit comment', 'rest/reference/reactions/#create-reaction-for-a-commit-comment', [], [['content', str]], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-commit-comment', 'Delete a commit comment reaction', 'rest/reference/reactions/#delete-a-commit-comment-reaction', [], [], 'squirrel-girl'),
 ...
 ('/repos/{owner}/{repo}/community/code_of_conduct', 'get', 'codes-of-conduct/get-for-repo', 'Get the code of conduct for a repository', 'rest/reference/codes_of_conduct/#get-the-code-of-conduct-for-a-repository', [], [], 'scarlet-witch'),
 ...
 ('/repos/{owner}/{repo}/environments', 'get', 'repos/get-all-environments', 'Get all environments', 'rest/reference/repos#get-all-environments', [], [], ''),
 ...
 ('/repos/{owner}/{repo}/issues', 'get', 'issues/list-for-repo', 'List repository issues', 'rest/reference/issues/#list-repository-issues', ['milestone', 'state', 'assignee', 'creator', 'mentioned', 'labels', 'sort', 'direction', 'since', 'per_page', 'page'], [], 'squirrel-girl'),
 ...
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions', 'get', 'reactions/list-for-issue-comment', 'List reactions for an issue comment', 'rest/reference/reactions/#list-reactions-for-an-issue-comment', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions', 'post', 'reactions/create-for-issue-comment', 'Create reaction for an issue comment', 'rest/reference/reactions/#create-reaction-for-an-issue-comment', [], [['content', str]], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-issue-comment', 'Delete an issue comment reaction', 'rest/reference/reactions/#delete-an-issue-comment-reaction', [], [], 'squirrel-girl'),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}', 'get', 'issues/get', 'Get an issue', 'rest/reference/issues/#get-an-issue', [], [], 'squirrel-girl'),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}/labels', 'post', 'issues/add-labels', 'Add labels to an issue', 'rest/reference/issues#add-labels-to-an-issue', [], [], ''),
 ('/repos/{owner}/{repo}/issues/{issue_number}/labels', 'put', 'issues/set-labels', 'Set labels for an issue', 'rest/reference/issues#set-labels-for-an-issue', [], [], ''),
 ...
 ('/repos/{owner}/{repo}/issues/{issue_number}/reactions', 'get', 'reactions/list-for-issue', 'List reactions for an issue', 'rest/reference/reactions/#list-reactions-for-an-issue', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/issues/{issue_number}/reactions', 'post', 'reactions/create-for-issue', 'Create reaction for an issue', 'rest/reference/reactions/#create-reaction-for-an-issue', [], [['content', str]], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/issues/{issue_number}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-issue', 'Delete an issue reaction', 'rest/reference/reactions/#delete-an-issue-reaction', [], [], 'squirrel-girl'),
 ...
 ('/repos/{owner}/{repo}/projects', 'get', 'projects/list-for-repo', 'List repository projects', 'rest/reference/projects/#list-repository-projects', ['state', 'per_page', 'page'], [], 'inertia'),
 ('/repos/{owner}/{repo}/projects', 'post', 'projects/create-for-repo', 'Create a repository project', 'rest/reference/projects/#create-a-repository-project', [], [['name', str], ['body', str]], 'inertia'),
 ...
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions', 'get', 'reactions/list-for-pull-request-review-comment', 'List reactions for a pull request review comment', 'rest/reference/reactions/#list-reactions-for-a-pull-request-review-comment', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions', 'post', 'reactions/create-for-pull-request-review-comment', 'Create reaction for a pull request review comment', 'rest/reference/reactions/#create-reaction-for-a-pull-request-review-comment', [], [['content', str]], 'squirrel-girl'),
 ('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions/{reaction_id}', 'delete', 'reactions/delete-for-pull-request-comment', 'Delete a pull request comment reaction', 'rest/reference/reactions/#delete-a-pull-request-comment-reaction', [], [], 'squirrel-girl'),
 ...
 ('/repos/{owner}/{repo}/pulls/{pull_number}/update-branch', 'put', 'pulls/update-branch', 'Update a pull request branch', 'rest/reference/pulls/#update-a-pull-request-branch', [], [['expected_head_sha', str]], 'lydian'),
 ...
 ('/repos/{owner}/{repo}/releases', 'post', 'repos/create-release', 'Create a release', 'rest/reference/repos#create-a-release', [], [['tag_name', str], ['target_commitish', str], ['name', str], ['body', str], ['draft', bool, False], ['prerelease', bool, False], ['discussion_category_name', str]], ''),
 ...
 ('/repos/{owner}/{repo}/secret-scanning/alerts', 'get', 'secret-scanning/list-alerts-for-repo', 'List secret scanning alerts for a repository', 'rest/reference/secret-scanning#list-secret-scanning-alerts-for-a-repository', ['state', 'page', 'per_page'], [], ''),
 ...
 ('/repos/{owner}/{repo}/topics', 'get', 'repos/get-all-topics', 'Get all repository topics', 'rest/reference/repos/#get-all-repository-topics', ['page', 'per_page'], [], 'mercy'),
 ('/repos/{owner}/{repo}/topics', 'put', 'repos/replace-all-topics', 'Replace all repository topics', 'rest/reference/repos/#replace-all-repository-topics', [], [['names', list]], 'mercy'),
 ...
 ('/repos/{owner}/{repo}/vulnerability-alerts', 'get', 'repos/check-vulnerability-alerts', 'Check if vulnerability alerts are enabled for a repository', 'rest/reference/repos/#check-if-vulnerability-alerts-are-enabled-for-a-repository', [], [], 'dorian'),
 ('/repos/{owner}/{repo}/vulnerability-alerts', 'put', 'repos/enable-vulnerability-alerts', 'Enable vulnerability alerts', 'rest/reference/repos/#enable-vulnerability-alerts', [], [], 'dorian'),
 ('/repos/{owner}/{repo}/vulnerability-alerts', 'delete', 'repos/disable-vulnerability-alerts', 'Disable vulnerability alerts', 'rest/reference/repos/#disable-vulnerability-alerts', [], [], 'dorian'),
 ...
 ('/repos/{template_owner}/{template_repo}/generate', 'post', 'repos/create-using-template', 'Create a repository using a template', 'rest/reference/repos/#create-a-repository-using-a-template', [], [['owner', str], ['name', str], ['description', str], ['include_all_branches', bool, False], ['private', bool, False]], 'baptiste'),
 ...
 ('/search/commits', 'get', 'search/commits', 'Search commits', 'rest/reference/search/#search-commits', ['q', 'sort', 'order', 'per_page', 'page'], [], 'cloak'),
 ...
 ('/search/labels', 'get', 'search/labels', 'Search labels', 'rest/reference/search/#search-labels', ['repository_id', 'q', 'sort', 'order'], [], ''),
 ('/search/repositories', 'get', 'search/repos', 'Search repositories', 'rest/reference/search/#search-repositories', ['q', 'sort', 'order', 'per_page', 'page'], [], 'mercy'),
 ('/search/topics', 'get', 'search/topics', 'Search topics', 'rest/reference/search/#search-topics', ['q'], [], 'mercy'),
 ...
 ('/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'get', 'reactions/list-for-team-discussion-comment-legacy', 'List reactions for a team discussion comment (Legacy)', 'rest/reference/reactions/#list-reactions-for-a-team-discussion-comment-legacy', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions', 'post', 'reactions/create-for-team-discussion-comment-legacy', 'Create reaction for a team discussion comment (Legacy)', 'rest/reference/reactions/#create-reaction-for-a-team-discussion-comment-legacy', [], [['content', str]], 'squirrel-girl'),
 ('/teams/{team_id}/discussions/{discussion_number}/reactions', 'get', 'reactions/list-for-team-discussion-legacy', 'List reactions for a team discussion (Legacy)', 'rest/reference/reactions/#list-reactions-for-a-team-discussion-legacy', ['content', 'per_page', 'page'], [], 'squirrel-girl'),
 ('/teams/{team_id}/discussions/{discussion_number}/reactions', 'post', 'reactions/create-for-team-discussion-legacy', 'Create reaction for a team discussion (Legacy)', 'rest/reference/reactions/#create-reaction-for-a-team-discussion-legacy', [], [['content', str]], 'squirrel-girl'),
 ...
 ('/teams/{team_id}/projects', 'get', 'teams/list-projects-legacy', 'List team projects (Legacy)', 'rest/reference/teams/#list-team-projects-legacy', ['per_page', 'page'], [], 'inertia'),
 ('/teams/{team_id}/projects/{project_id}', 'get', 'teams/check-permissions-for-project-legacy', 'Check team permissions for a project (Legacy)', 'rest/reference/teams/#check-team-permissions-for-a-project-legacy', [], [], 'inertia'),
 ('/teams/{team_id}/projects/{project_id}', 'put', 'teams/add-or-update-project-permissions-legacy', 'Add or update team project permissions (Legacy)', 'rest/reference/teams/#add-or-update-team-project-permissions-legacy', [], [['permission', str]], 'inertia'),
 ...
 ('/user/issues', 'get', 'issues/list-for-authenticated-user', 'List user account issues assigned to the authenticated user', 'rest/reference/issues/#list-user-account-issues-assigned-to-the-authenticated-user', ['filter', 'state', 'labels', 'sort', 'direction', 'since', 'per_page', 'page'], [], 'squirrel-girl'),
 ...
 ('/user/projects', 'post', 'projects/create-for-authenticated-user', 'Create a user project', 'rest/reference/projects/#create-a-user-project', [], [['name', str], ['body', str]], 'inertia'),
 ...
 ('/users/{username}/projects', 'get', 'projects/list-for-user', 'List user projects', 'rest/reference/projects/#list-user-projects', ['state', 'per_page', 'page'], [], 'inertia'),
 ...
 ('/users/{username}/repos', 'get', 'repos/list-for-user', 'List repositories for a user', 'rest/reference/repos/#list-repositories-for-a-user', ['type', 'sort', 'direction', 'per_page', 'page'], [], 'nebula'),
