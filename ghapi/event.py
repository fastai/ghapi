...
__all__ = ['GhEvent', 'load_sample_events', 'save_sample_events', 'full_type', 'evt_emojis', 'description', 'emoji',
           'text', 'described_evts']
...
# Cell
#hide
described_evts = (PushEvent,DeleteEvent,CreateEvent,PullRequestEvent,MemberEvent,PublicEvent,PullRequestReviewCommentEvent,ForkEvent,
